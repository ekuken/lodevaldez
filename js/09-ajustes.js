...
function renderAjustes(){
  ...
  h += '<div class="card" style="margin-top:16px"><div class="hd"><h3>❓ Cómo se usa</h3></div><div class="bd small" style="line-height:1.7">' +
    ...
    '<p style="margin:0 0 8px"><b>Formas de cobro.</b> Son dos toques: <b>Cobrar</b> y después la forma de pago, y con ese segundo toque la mesa ya queda cobrada y libre. Si pagan con <b>crédito</b> se suma solo el recargo configurado (el aviso aparece antes de tocarlo). Si pagan a <b>cuenta</b> y hay más de una, pregunta a cuál se carga. Para calcular el <b>vuelto</b> hay un botón aparte, “Efectivo, calculando el vuelto”: ahí escribís con cuánto te pagan y el sistema dice cuánto devolver (con botones rápidos de 1k, 2k, 5k, 10k y 20k). Y con <b>“Dividir entre varias formas de pago”</b> repartís el total o lo dividís en partes iguales entre 2, 3, 4 o las personas que quieras, cada parte con su propio medio; el botón de cobrar se habilita recién cuando el reparto cubre el total exacto.</p>' +
